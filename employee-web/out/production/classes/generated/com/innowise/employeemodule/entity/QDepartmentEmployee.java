...
public class QDepartmentEmployee extends EntityPathBase<DepartmentEmployee> {
    ...
    public final DateTimePath<java.time.LocalDateTime> endDateInDepartment = createDateTime("endDateInDepartment", java.time.LocalDateTime.class);

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final BooleanPath isCurrentDepartment = createBoolean("isCurrentDepartment");

    public final DateTimePath<java.time.LocalDateTime> startDateInDepartment = createDateTime("startDateInDepartment", java.time.LocalDateTime.class);
